...
|-------|-------------------|-----------------|------------------------|
|100    |Too High, Go Lower |Too Low,Go Higher|none                    |

|Attempt|Score -5           |Score +5 (reward)|none                    |
|2 wrong|                   |                 |                        |
|guess. |                   |                 |                        |

|Click  |Fresh game, score  |Score and status |none                    |
|"New   |resets to 0        |carry over from  |                        |
|Game"  |                   |previous game.   |                        |
|after  |                   |                 |                        |
|losing |                   |                 |                        |
